"""
Enhanced Data Generator for All 45 Parts
Generates realistic usage data for all parts in your database
"""
...
def save_enhanced_data():
    """Generate and save enhanced data to CSV"""
    print("Generating enhanced automotive parts data for all 45 parts...")
    df = generate_all_parts_data()
    
    # Save to CSV
    df.to_csv('../data/automotive_parts_usage_enhanced.csv', index=False)
